...
const cloudinary = require(`../student_management_system/config/cloudinary.js`)
const sendMail = require(`../student_management_system/helpers/email.js`);
const {
    signUpTemplate,
    verifyTemplate,
    forgotPasswordTemplate,
} = require(`../student_management_system/helpers/html.js`);
